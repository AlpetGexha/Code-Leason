                                        ...
                                        <td>
                                            <div class="btn-group" role="group"
                                                ...
                                                <button type="button" class="btn btn-outline-primary"
                                                    data-bs-toggle="modal" data-bs-target="#updatesTodo"
                                                ...
                                                <button type="button" class="btn btn-outline-primary"
                                                    data-bs-toggle="modal" data-bs-target="#editTodo"
                                                    wire:click.prevent='edit({{ $todo->id }})'>
                                                    <i class="far fa-eye" data-bs-toggle="tooltip"
                                                ...
                                                @else
                                                    <button type="button" class="btn btn-outline-primary"
                                                        ...
                                                        <i class="fas fa-ban" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="UnComplete"></i>
                                                    </button>
                                                @endif
                                            </div>
                                        </td>
